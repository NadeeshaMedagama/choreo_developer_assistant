                ...
                <ReactMarkdown
                  ...
                  components={{
                    code({ node, inline, className, children, ...props }) {
                      ...
                      // Render Mermaid diagrams - but only when not streaming
                      if (language === 'mermaid') {
                        // Don't render diagram while streaming - wait until complete
                        if (message.streaming) {
                          return (
                            <div className={`p-4 rounded-lg border ${
                              ...
                              <pre className="text-xs mt-2 opacity-50 overflow-hidden max-h-20">{code.slice(0, 200)}...</pre>
                            </div>
                          )
                        }
                        return (
